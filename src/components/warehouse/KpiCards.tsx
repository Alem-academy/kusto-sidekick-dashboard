...
export function KpiCards({ 
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
      ...
      <Card className="cursor-pointer transition-all hover:shadow-md border-green-200 bg-green-50">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <CardContent>
          ...
          <p className="text-xs text-gray-600">Объявленная стоимость товаров</p>
        </CardContent>
      </Card>
    </div>
  );
